...
let energyLevels = fs.readFileSync('Day11/inputs/input11.txt').toString().split("\n");
...
let flashsCount;
let step = 0;
let gridSize = energyLevels.length * energyLevels[0].length;
